...
namespace Persistence.DatabaseContext
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<CourseLessonLearnedsPerStudent> CourseLessonLeardnedsPerStudents { get; set; }
        public DbSet<Income> Cincomes { get; set; }
        public DbSet<LessonsPerCourse> LessonPerCourses { get; set; }
        public DbSet<ReviewsPerCourse> ReviewsPerCourses { get; set; }
        public DbSet<UsersPerCourse> UserPerCourses { get; set; }
